<footer class="bg-white">
        <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            ...
            <div class="text-center">
                ...
                <span class="block text-sm text-center text-gray-500">© <?php echo date("Y"); ?> Toolsborg™. All Rights Reserved. Develop by <a href="https://www.linkedin.com/in/rizki-agung-prasetyo-33b7b1182/" class="text-purple-600 hover:underline">Rizki Agung</a>
                </span>
