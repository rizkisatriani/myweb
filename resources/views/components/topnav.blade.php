            ...
            <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0 gap-16">
                    ...
                    <li class="relative group">
                        ...
                        <div class="absolute left-0 top-0 right-0 hidden group-hover:block bg-white border-t border-gray-200 shadow-lg z-40" style="position: fixed;">
                        ...
                        <a href="/blogs" class="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Blogs</a>
                    </li>
                </ul>
            </div>
        </div>
