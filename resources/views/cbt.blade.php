...
<section class="bg-white">
    <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
        <div class="mr-auto place-self-center lg:col-span-7">
            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl">Aplikasi Komputer <br>Base Test.</h1>
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl">Solusi Ujian Berbasis Komputer yang Efisien, Akurat, dan Mudah Dikelola! 🚀</p>
            <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                <a href="https://www.youtube.com/@programmerninja1950" target="_blank" class="inline-flex items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-gray-900 border border-gray-200 rounded-lg sm:w-auto hover:bg-gray-100 focus:ring-4 focus:ring-gray-100">
...
<section class="bg-white">
    <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
        <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
            <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900">Boost Efficiency with Our Powerful Features! 🚀</h2>
        ...
        <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
            <!-- Pricing Card -->
            <div class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow xl:p-8 dark:bg-gray-800 dark:text-white">
                <h3 class="mb-4 text-2xl font-semibold">Image Convert</h3>
                <p class="font-light text-gray-500 sm:text-lg">Fast, easy, and high-quality conversions in just one click. Try it now!</p>
            ...
            <div class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow xl:p-8 dark:bg-gray-800 dark:text-white">
                ...
                <p class="font-light text-gray-500 sm:text-lg">Fast, easy, and high-quality document conversion in one click. Try it now!</p>
                <div class="flex items-baseline justify-center my-8">
            ...
            <div class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow xl:p-8 dark:bg-gray-800 dark:text-white">
                ...
                <p class="font-light text-gray-500 sm:text-lg">Quick, accurate, and reliable speed test in just one click. Check your connection!</p>
                <div class="flex items-baseline justify-center my-8">
