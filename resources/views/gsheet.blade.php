...
<section class="bg-white">
    <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <p class="max-w-2xl mb-6 text-gray-700 lg:mb-8 md:text-lg font-bold lg:text-xxl">
...
<section class="bg-white">
    <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
        <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
            <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900">Kelola keuangan jadi lebih mudah! 🚀</h2>
        ...
        <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
            ...
            <div class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow xl:p-8 dark:bg-gray-800 dark:text-white">
                ...
                <p class="font-light text-gray-500 sm:text-lg">Dashboard yang menyediakan rangkuman data keuangan kamu !</p>
            ...
            <div class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow xl:p-8 dark:bg-gray-800 dark:text-white">
                ...
                <p class="font-light text-gray-500 sm:text-lg">Gaji , Uang saku atau deviden saham kamu bisa di catat disini</p>
                <div class="flex items-baseline justify-center my-8">
            ...
            <div class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow xl:p-8 dark:bg-gray-800 dark:text-white">
                ...
                <p class="font-light text-gray-500 sm:text-lg">Bayar cicilan , tagihan listrik atau budget jalan sama si dia bisa catat disini </p>
                <div class="flex items-baseline justify-center my-8">
...
<section class="bg-white">
    <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
        <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
            ...
            <h2 class="mb-4 text-xl font-extrabold tracking-tight text-gray-900">
            ...
            <p class="mb-5 font-medium text-black-500 text-2xlsm:text-3xl">
