        ...
        <div class="container mx-auto">
            ...
            <div class="relative bg-purple-100 rounded-lg p-4">
                ...
                <div class="relative z-10 bg-white rounded-xl p-6">
                    ...
                    <!-- Image Preview -->
                    <div class="flex items-center mt-4" id="imgContainer" style="flex-direction: column;">
                        <img src="" alt="Preview" id="imgPreview">
                        <h1 class="text-3xl font-extrabold text-gray-800 text-center mb-4 mt-6">File Uploaded</h1>
                    </div>
