...
Route::get('/saldo-perbukan', [KeuanganController::class, 'getSaldoAkhirPerBulan'])->middleware('auth:sanctum');
Route::post('/keuangan', [KeuanganController::class, 'store'])->middleware('auth:sanctum');;
